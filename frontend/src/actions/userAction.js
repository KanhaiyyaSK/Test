...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://test-sk-d4kf.onrender.com/api/v1/login`,
      { email, password },
      config
    );
...
export const logout = () => async (dispatch) => {
  try {
    await axios.get(`https://test-sk-d4kf.onrender.com/api/v1/logout`);
...
export const updatePassword = (passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `https://test-sk-d4kf.onrender.com/api/v1/password/update`,
      passwords,
      config
    );
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `https://test-sk-d4kf.onrender.com/api/v1/password/reset/${token}`,
      passwords,
      config
    );
